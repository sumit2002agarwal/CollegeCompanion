...
const Sprofile = () => {
  ...
  const token = cookies.get("jwtoken");
   ...
   const callTlogin = async () => {
    try {
      const res = await fetch("https://college-companion.onrender.com/afterslogin", {
        method: "GET",
        headers: {
  ...
  const PostEdit = async (e) => {
    ...
    const res = await fetch("https://college-companion.onrender.com/api/changepasswordstu", {
      method: "PUT",
